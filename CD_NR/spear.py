...
class Spear:
	...
	def draw(self,world):
		if self.active:
			world.blit(self.rot_center(self.frames[self.currentFrame],self.angle),(self.x - self.shift,self.y - self.shift))
		else:
